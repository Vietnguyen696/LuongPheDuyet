...
export const DisciplineModal: React.FC<DisciplineModalProps> = ({ 
  ...
  const [formData, setFormData] = useState({
      disciplineYear: record?.disciplineYear || '2025',
      ...
      disciplineContent: record?.disciplineContent || '',
      disciplineNote: record?.disciplineNote || ''
  });
      ...
      <div className="bg-white rounded-lg shadow-2xl w-full max-w-5xl flex flex-col max-h-[95vh] overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-gray-50">
          <h3 className="text-lg font-bold text-gray-800 uppercase tracking-wide">
             {isCreate ? "Tạo mới Kỷ luật Đảng viên" : "Chi tiết Kỷ luật Đảng viên"}
          </h3>
        ...
        <div className="flex-1 overflow-y-auto p-6 bg-white">
          ...
          <section className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-4">
                {/* Row 1 */}
                <div>
                    <label className={labelClass}>Năm kỷ luật <span className="text-red-500">*</span></label>
                    <input type="text" className={inputClass} value={formData.disciplineYear} readOnly={!isCreate} />
                </div>
                <div>
                ...
                <div>
                    <label className={labelClass}>Hình thức kỷ luật <span className="text-red-500">*</span></label>
                    <select className={inputClass} value={formData.disciplineType} disabled={!isCreate}>
                         ...
                         <option value="Khai trừ">Khai trừ</option>
                         <option value="Giải tán">Giải tán</option>
                    </select>
                </div>
                <div>
                ...
                <div className="col-span-1 md:col-span-3">
                    <label className={labelClass}>Nội dung vi phạm/kỷ luật</label>
                    <input type="text" className={readOnlyClass} value={formData.disciplineContent} readOnly={!isCreate} />
                </div>
                
                {/* Row 4 */}
                <div className="col-span-1 md:col-span-3">
                    <label className={labelClass}>Ghi chú</label>
                    <input type="text" className={readOnlyClass} value={formData.disciplineNote} readOnly={!isCreate} />
                </div>
